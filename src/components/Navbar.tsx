    ...
    <>
      ...
      {isMenuOpen && (
        <>
          ...
          />
          <div className="fixed right-0 top-0 h-full w-80 bg-card shadow-lg z-50 animate-slide-in">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full text-left py-3 px-4 hover:bg-destructive hover:text-destructive-foreground rounded-lg transition-colors"
                >
                  Logout
                </button>
              </div>
